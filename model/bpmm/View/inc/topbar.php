		...
		<div class="container">
			<div class="nav-wrapper">
				...
				<ul class="right hide-on-med-and-down">
					...
					<li class="<?php echo ($_GET['a']=="index")?"active" : ""; ?>"><a href="<?=ROOT_URL?>../bpmm">Accueil</a></li>
					<li class="<?php echo ($_GET['a']=="index")?"active" : ""; ?>"><a href="<?=ROOT_URL?>../../../SVHCBP/model/bpmm/View/chapters.php">Chapitres</a></li>
					<li class="<?php echo ($_GET['a']=="index")?"active" : ""; ?>"><a href="<?=ROOT_URL?>../../blog.php">2nd Blog</a></li>
          <li class="<?php echo ($_GET['a']=="index")?"active" : ""; ?>"><a href="<?=ROOT_URL?>../../index.php">Retour B.Projet</a></li>

					<?php if (empty($_SESSION['is_admin']) && empty($_SESSION['is_user'])): ?>
					<li><a href="<?=ROOT_URL?>../../../SVHCBP/model/bpmm/View/login.php" class="btn green waves-effect waves-light">Connexion<i class="material-icons right">lock_open</i></a></li>
					<?php endif ?>
				...
				<ul class="side-nav" id="mobile-menu">
					...
					<?php if (empty($_SESSION['is_admin']) && empty($_SESSION['is_user'])): ?>
					<li class="<?php echo ($_GET['a']=="login")?"active" : ""; ?>"><a href="<?=ROOT_URL?>../../../SVHCBP/model/bpmm/View/login.php">Connexion</a></li>
					<?php endif ?>
